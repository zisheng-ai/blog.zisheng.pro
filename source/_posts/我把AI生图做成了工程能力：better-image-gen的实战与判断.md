...
description: 这篇文章复盘我近期把 AI 生图用于商业封面、产品角色、透明图标、macOS App Icon、动态壁纸与帧动画的真实过程，并介绍 better-image-gen 如何把模型路由、Prompt 约束、后处理、交付规格和元数据沉淀成一套可复用的视觉工程能力。
categories:
  - [AI]
tags:
  - better-image-gen
...
最近两周，我密集地用 AI 生成了几类差异很大的视觉资产：Facebook 小说投放封面、产品竞赛主视觉、Agent 角色分身、18px 菜单栏帧动画、macOS App Icon、动态壁纸、错误状态插画，以及博客和社交媒体封面。
...
| 场景 | 难点 | 最终沉淀的能力 |
|---|---|---|
| Facebook 小说封面 | 0.3 秒内建立冲突，至少 3 个人物，真实感和 CTR 优先 | `portrait / cover` 构图规范、人物数量与情绪约束 |
...
4. Delivery context：Feed、菜单栏、桌面、App Icon、头像
...
4. **验收层**：在真实 Feed、菜单栏、Dock、网页里效果如何？
...
| 输出要进入代码、客户端或投放系统吗？ | 增加后处理和验收 | 保存图片即可 |
